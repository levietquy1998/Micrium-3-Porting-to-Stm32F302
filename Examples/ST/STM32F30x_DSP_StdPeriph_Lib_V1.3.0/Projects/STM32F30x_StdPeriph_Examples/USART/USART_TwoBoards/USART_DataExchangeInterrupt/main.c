...
__IO uint32_t RxIndex = 0x00;
__IO uint32_t TxIndex = 0x00;

__IO JOYState_TypeDef PressedButton  = JOY_NONE;
__IO uint32_t UsartMode = USART_MODE_TRANSMITTER;
__IO uint32_t UsartTransactionType = USART_TRANSACTIONTYPE_CMD;
